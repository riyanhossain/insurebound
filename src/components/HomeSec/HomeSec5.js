  ...
  return (
    <section>
      <div className="flex justify-center items-center">
        <div className="w-screen h-[2448px] flex flex-col justify-evenly md:h-[850px] md:w-[1050px] md:items-center">
          <div className="flex flex-col justify-center items-center gap-y-5">
                <p className="text-black text-4xl font-bold">Pricing</p>
                <p className="w-[300px] text-center">
                Problems trying to resolve the conflict between the two major
                realms of Classical physics: Newtonian mechanics.
                </p>
          </div>
          <div className="flex flex-col justify-evenly items-center h-[2115px] md:h-[605px] md:flex-row md:justify-between md:w-[985px]">
            ...
            <div class="shadow-lg rounded-2xl w-64 bg-indigo-500 dark:bg-gray-800 p-4">
              <div class="flex text-white  items-center justify-between">
                <p class="text-4xl font-medium mb-4">Pro</p>
                <p class="text-3xl font-bold flex flex-col">
                  $99
                  <span class="font-thin text-right text-sm">month</span>
                </p>
              </div>
